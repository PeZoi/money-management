  ...
  return (
    <DrawerPortal>
      ...
      >
        ...
        <div className="mx-auto my-3 h-1.5 w-12 shrink-0 rounded-full bg-muted-foreground/20" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn('font-heading font-medium text-foreground text-lg leading-none tracking-tight', className)}
      {...props}
    />
  );
}
