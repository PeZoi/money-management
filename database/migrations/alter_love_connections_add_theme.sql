-- =====================================================
-- MIGRATION: Add Theme Column to Love Connections
-- =====================================================

-- 1. Thêm cột theme vào bảng love_connections
ALTER TABLE public.love_connections 
ADD COLUMN IF NOT EXISTS theme text DEFAULT 'rose';

-- 2. Xóa hàm RPC cũ để tránh xung đột kiểu dữ liệu trả về
DROP FUNCTION IF EXISTS public.get_my_love_connection();

-- 3. Tạo lại hàm RPC trả về đầy đủ thông tin bao gồm cả cột theme
